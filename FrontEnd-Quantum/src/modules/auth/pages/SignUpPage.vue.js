...
// @ts-ignore
const __VLS_8 = __VLS_asFunctionalComponent(PageHeadings, new PageHeadings({
    subtitle: "Let's start creating your account!",
}));
const __VLS_9 = __VLS_8({
    subtitle: "Let's start creating your account!",
}, ...__VLS_functionalComponentArgsRest(__VLS_8));
const __VLS_11 = {}.QForm;
...
// @ts-ignore
const __VLS_35 = __VLS_asFunctionalComponent(PasswordInput, new PasswordInput({
    ...{ class: "full-width" },
    label: "Password",
    standout: "bg-primary text-white",
...
/** @type {[typeof PageHeadings, ]} */ ;
// @ts-ignore
const __VLS_49 = __VLS_asFunctionalComponent(PageHeadings, new PageHeadings({
...
// @ts-ignore
const __VLS_64 = __VLS_asFunctionalComponent(ErrorBox, new ErrorBox({
