...
const __VLS_10 = __VLS_asFunctionalComponent(__VLS_9, new __VLS_9({
    ...{ class: "absolute-center column justify-center" },
}));
...
const __VLS_18 = __VLS_asFunctionalComponent(__VLS_17, new __VLS_17({
    ...{ class: "row  row justify-center q-mb-lg" },
}));
const __VLS_19 = __VLS_18({
    ...{ class: "row  row justify-center q-mb-lg" },
}, ...__VLS_functionalComponentArgsRest(__VLS_18));
__VLS_20.slots.default;
const __VLS_21 = {}.QItem;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div)({
    ...{ class: "bg-primary full-width full-height" },
    ...{ style: {} },
});
var __VLS_3;
...
/** @type {__VLS_StyleScopedClasses['absolute-center']} */ ;
...
/** @type {__VLS_StyleScopedClasses['gt-md']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-primary']} */ ;
